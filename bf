...
setclipboard("https://loot-link.com/s?cLMDkZBL")

local Window = Rayfield:CreateWindow({
   Name = "Laws Hub - Key System",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Laws Hub - Blox Fruit | v1",
   ...
   Discord = {
      Enabled = true,
      Invite = "https://discord.gg/pMpagSJBuQ", 
      RememberJoins = true 
   },
   ...
   KeySettings = {
      Title = "Laws Hub",
      Subtitle = "Key System",
      Note = "Complete the tasks. Support is in discord.", 
      FileName = "Key", 
      SaveKey = false, 
      GrabKeyFromSite = false, 
      Key = {"7kXIp3c7xagN1q7O", "98xz6sfgv32ft23z"}
   }
})
...
local Update = loadstring(game:HttpGet("https://gist.githubusercontent.com/LawsHub/40f6c38f45a77514466320e1438cf0c2/raw/dcb6ec3d8dddfe748c3a17753ae5dc1972bf5f2e/UI"))();

local Library = Update:Window({
	SubTitle = "Blox Fruit v1",
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("LawsHub") then
			makefolder("LawsHub");
		end;
		if not isfolder("LawsHub/Blox Fruits/") then
			makefolder("LawsHub/Blox Fruits/");
		end;
		if not isfile(("LawsHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("LawsHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("LawsHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("LawsHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("LawsHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
-- if you are here i decided to delete the tabs cuz it didnt work..
